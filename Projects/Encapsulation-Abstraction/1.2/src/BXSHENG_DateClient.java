...
//		System.out.println("Recieved day of " + today.getDay() + ".");
//		System.out.println("Recieved month of " + today.getMonth() + ".");
//		System.out.println("Recieved year of " + today.getYear() + ".");
//		System.out.println("Recieved dayOfWeek of " + today.getDayOfWeek() + ".");
//		System.out.println("Leap Year: " + today.isLeapYear() + ".");
//		System.out.println("Recieved string date of " + today.toString() + ".");
//		System.out.println();
//		System.out.println();
//		System.out.println();
//		System.out.println();
//		Date sampleDate = new Date(1900, 1, 1);
//		System.out.println("Recieved day of " + sampleDate.getDay() + ".");
//		System.out.println("Recieved month of " + sampleDate.getMonth() + ".");
//		System.out.println("Recieved year of " + sampleDate.getYear() + ".");
//		System.out.println("Recieved dayOfWeek of " + sampleDate.getDayOfWeek() + ".");
//		System.out.println("Leap Year: " + sampleDate.isLeapYear() + ".");
//		System.out.println("Recieved string date of " + sampleDate.toString() + ".");
//	}
//}
